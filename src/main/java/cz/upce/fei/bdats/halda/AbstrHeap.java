...
// <editor-fold defaultstate="collapsed" desc="Metoda: void vybuduj(E[] pole)">
    ...
    public void vybuduj(E[] pole) throws HeapException {
        ...
        final int pulka = mohutnost() / 2 - 1;
        for (int i = pulka; i >= 0; i--) {
            int aktualniIndex = i;
            while (aktualniIndex < mohutnost() / 2) {
     ...
     */
    private boolean nejsouStejneIndexy(int nejlepsiIndex, int aktualniIndex) {
